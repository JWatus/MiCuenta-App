...
public class DataCreator {
    ...
    public Debtor createDebtor() {
        ...
        Payment paymentOne = new Payment(LocalDate.of(2009, 9, 9),
                BigDecimal.valueOf(500.00).setScale(2, RoundingMode.HALF_EVEN), creditCardOne, "Alivio");
        Payment paymentTwo = new Payment(LocalDate.of(2014, 1, 19),
                BigDecimal.valueOf(700.00).setScale(2, RoundingMode.HALF_EVEN), creditCardTwo, "Velka");
        Payment paymentThree = new Payment(LocalDate.of(2015, 6, 6),
                BigDecimal.valueOf(700.00).setScale(2, RoundingMode.HALF_EVEN), creditCardTwo, "Alivio");
        Payment paymentFour = new Payment(LocalDate.of(2015, 7, 28),
                BigDecimal.valueOf(700.00).setScale(2, RoundingMode.HALF_EVEN), creditCardTwo, "Velka");
        Payment paymentFive = new Payment(LocalDate.of(2015, 7, 28),
                BigDecimal.valueOf(150.00).setScale(2, RoundingMode.HALF_EVEN), creditCardTwo, "Alivio");
        Payment paymentSix = new Payment(LocalDate.of(2015, 7, 28),
                BigDecimal.valueOf(671.00).setScale(2, RoundingMode.HALF_EVEN), creditCardTwo, "Velka");
        ...
        Debt debtOne = new Debt(BigDecimal.valueOf(50000.00).setScale(2, RoundingMode.HALF_EVEN), LocalDate.of(2017, 11, 16),
                setOfPaymentsOne, "CRTP/909088", "Cross Finance");
        Debt debtTwo = new Debt(BigDecimal.valueOf(60000.00).setScale(2, RoundingMode.HALF_EVEN), LocalDate.of(2018, 2, 6),
                setOfPaymentsTwo, "KIGT/116256", "India Lends");
        Debt debtThree = new Debt(BigDecimal.valueOf(4000.00).setScale(2, RoundingMode.HALF_EVEN), LocalDate.of(1999, 12, 1),
                setOfPaymentsThree, "PLWT/871422", "King Of Kash");
        Debt debtFour = new Debt(BigDecimal.valueOf(35000.00).setScale(2, RoundingMode.HALF_EVEN), LocalDate.of(1974, 6, 6),
