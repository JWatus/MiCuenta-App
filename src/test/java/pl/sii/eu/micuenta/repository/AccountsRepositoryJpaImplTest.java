...
public class AccountsRepositoryJpaImplTest {
    ...
    public void shouldReturnDebtorBySsn() {
        ...
        //than
        DebtorEntity actual = accountRepositorySQL.findFirstBySsn(expected.getSsn());
    ...
    public void shouldReturnDebtorBySsnAndFirstNameAndLastName() {
        ...
        //when
        accountsRepository.save(expected);
        Optional<DebtorEntity> actual = accountRepositorySQL.findFirstBySsnAndFirstNameAndLastName("980-122-111", "Jakub", "Watus");
    ...
    public void shouldReturnNullDebtorWhenFetchBySsnAndFirstNameAndLastName() {
        ...
        //when
        accountsRepository.save(expected);
        Optional<DebtorEntity> actual = accountRepositorySQL.findFirstBySsnAndFirstNameAndLastName("notExisting", "notExisting", "notExisting");
